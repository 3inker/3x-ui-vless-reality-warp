...
> 
> Рекомендуется использовать данный гайд: **[https://github.com/3inker/warp-dante-proxy](https://github.com/3inker/warp-dante-proxy)**
> 
> При использовании `warp-cli` (способ, описанный ниже) существует **утечка IP вашего VPS сервера по UDP**. Это может привести к раскрытию реального IP-адреса сервера. Альтернативный метод через Dante-прокси решает эту проблему и является более безопасным.
